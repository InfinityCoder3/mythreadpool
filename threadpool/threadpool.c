...
threadpool_t *threadpool_create(int min_thr_num, int max_thr_num, int queue_max_size)
{
    ...
    do {
        ...
        printf("create manager thread 0x%x...\n", (unsigned int)pool->adjust_tid);
...
int main(void)
{
    ...
    threadpool_t *thp = threadpool_create(2,100,100);/*创建线程池，池里最小3个线程，最大100，队列最大100*/
    printf("pool inited\n");
